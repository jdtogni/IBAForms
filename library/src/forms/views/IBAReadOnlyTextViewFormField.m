...
#import "IBAReadOnlyTextViewFormField.h"


@implementation IBAReadOnlyTextViewFormField
...
- (IBATextViewFormFieldCell *)textFormFieldCell {
	if (textFormFieldCell_ == nil) {
		textFormFieldCell_ = [[IBATextViewFormFieldCell alloc] initWithFormFieldStyle:self.formFieldStyle reuseIdentifier:@"Cell"];
		textFormFieldCell_.textField.editable = NO;
