...
#import "IBATextViewFormFieldCell.h"

@implementation IBATextViewFormFieldCell
...
- (id)initWithFormFieldStyle:(IBAFormFieldStyle *)style reuseIdentifier:(NSString *)reuseIdentifier {
    if ((self = [super initWithFormFieldStyle:style reuseIdentifier:reuseIdentifier])) {
		...
		self.textField = [[UITextView alloc] initWithFrame:style.valueFrame];
        ...
        self.cellView.frame = CGRectMake(0,0,style.valueFrame.size.width+5,style.valueFrame.size.height+10);
	}
